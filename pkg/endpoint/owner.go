...
type Owner interface {
	...
	// ModifyCTEntries modifies the entries in the Connection Tracking table for
	...
	ModifyCTEntries(e *Endpoint, isCTLocal bool, ips []net.IP, idsToMod policy.SecurityIDContexts)
