...
type DaemonSuite struct {
	...
	OnModifyCTEntries                 func(e *e.Endpoint, isCTLocal bool, ips []net.IP, idsToMod policy.SecurityIDContexts)
...
func (ds *DaemonSuite) ModifyCTEntries(e *e.Endpoint, isCTLocal bool, ips []net.IP, idsToMod policy.SecurityIDContexts) {
	if ds.OnModifyCTEntries != nil {
		ds.OnModifyCTEntries(e, isCTLocal, ips, idsToMod)
		return
	}
	panic("ModifyCTEntries should not have been called")
}
